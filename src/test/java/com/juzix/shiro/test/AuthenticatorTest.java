...
public class AuthenticatorTest {
	...
	public void testAtLeastOneSuccessfulStrategy() {
		testStrategy("classpath:shiro-authenticator-atleastone-success.ini");
	}
	...
	public void testFirstSuccessfulStrategy() {
		testStrategy("classpath:shiro-authenticator-first-success.ini");
	}

	private void testStrategy(String configFile) {
		login(configFile);
		Subject subject = SecurityUtils.getSubject();
